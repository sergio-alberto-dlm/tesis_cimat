...
from gaussian_splatting_2d.utils.general_utils import inverse_sigmoid, get_expon_lr_func, build_rotation
from torch import nn
import os
from gaussian_splatting_2d.utils.system_utils import mkdir_p
from plyfile import PlyData, PlyElement
from gaussian_splatting_2d.utils.sh_utils import RGB2SH
from simple_knn._C import distCUDA2
from gaussian_splatting_2d.utils.graphics_utils import BasicPointCloud, getWorld2View2
from gaussian_splatting_2d.utils.general_utils import strip_symmetric, build_scaling_rotation
...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int, config):
    ...
    def create_pcd_from_image_and_depth(self, cam, depth, init=False):
        ...
        return self.create_from_pcd(pcd)
        
    def extend_from_pcd_seq(
        self, cam_info, kf_id=-1, init=False, depthmap=None
    ):
        fused_point_cloud, features, scales, rots, opacities = (
            self.create_pcd_from_image_and_depth(cam=cam_info, depth=depthmap, init=init)
        )
